...
export default function All_writeList(props) {
    ...
    return(
        <div id='all_write_list'>
            <div id='all_write_list_div'>
                <input defaultValue={id} id='input_id_value'></input>
